...
import com.example.restapi2.adapters.TodoAllAdapter
import com.example.restapi2.databinding.ActivityMainBinding
import com.example.restapi2.databinding.ItemDialogBinding
...
import com.example.restapi2.utils.Status
import com.example.restapi2.viewModel.MyViewModelFactory
import com.example.restapi2.viewModel.TodoViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        todoViewModel = ViewModelProvider(this, MyViewModelFactory(todoReposirory)).get(
